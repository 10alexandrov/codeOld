    ...
    <div class="container">
        <div class="col-8 offset-2 isla-list p-4 mt-5">
            <div class="ttl text-center mb-4">
                <h1>Configurar Máquina de Cambio</h1>
            </div>
            ...
            <form action="{{ route('configuration.update', $id) }}" method="POST">
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('MoneySymbol', $localConfig->MoneySymbol) }}" type="text" name="MoneySymbol"
                        class="form-control" id="floatingInput" placeholder="Símbolo monetario">
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('MoneyLowLimitToCreate', $localConfig->MoneyLowLimitToCreate) }}" type="number"
                        step="0.01" name="MoneyLowLimitToCreate" class="form-control" id="floatingInput"
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="MoneyAdaptLowValuesOnCreation"
                        ...
                        {{ old('MoneyAdaptLowValuesOnCreation', $localConfig->MoneyAdaptLowValuesOnCreation) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-floating mb-3">
                    <input
                        value="{{ old('MoneyLimitThatNeedsAuthorization', $localConfig->MoneyLimitThatNeedsAuthorization) }}"
                        type="number" step="0.01" name="MoneyLimitThatNeedsAuthorization" class="form-control"
                        id="floatingInput" placeholder="Límite hasta autorización">
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('MoneyLimitAbsolute', $localConfig->MoneyLimitAbsolute) }}" type="number"
                        step="0.01" name="MoneyLimitAbsolute" class="form-control" id="floatingInput"
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="MoneyLimitInTypeBets" id="MoneyLimitInTypeBets"
                        value="1"
                        {{ old('MoneyLimitInTypeBets', $localConfig->MoneyLimitInTypeBets) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('$MoneyDenomination', $localConfig->MoneyDenomination) }}" type="number"
                        step="0.01" name="MoneyDenomination" class="form-control" id="floatingInput"
                        placeholder="Denominación de pago">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="RoundPartialPrizes" id="RoundPartialPrizes"
                        value="1"
                        {{ old('RoundPartialPrizes', $localConfig->RoundPartialPrizes) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('RoundPartialPrizesValue', $localConfig->RoundPartialPrizesValue) }}"
                        type="number" step="0.50" name="RoundPartialPrizesValue" class="form-control" id="floatingInput"
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('NumberOfDigits', $localConfig->NumberOfDigits) }}" type="number"
                        name="NumberOfDigits" class="form-control" id="floatingInput" placeholder="Número de dígitos">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="NewTicketNumberFormat"
                        ...
                        {{ old('NewTicketNumberFormat', $localConfig->NewTicketNumberFormat) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('HeaderOfTicketNumber', $localConfig->HeaderOfTicketNumber) }}" type="text"
                        name="HeaderOfTicketNumber" class="form-control" id="floatingInput"
                        placeholder="Forzar cabecera del ticket">
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('HoursBetweenAutopurges', $localConfig->HoursBetweenAutopurges) }}"
                        type="number" name="HoursBetweenAutopurges" class="form-control" id="floatingInput"
                        placeholder="Autopurga cada (horas; 0 para desactivar)">
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('NumberOfEventsToAutopurge', $localConfig->NumberOfEventsToAutopurge) }}"
                        type="number" name="NumberOfEventsToAutopurge" class="form-control" id="floatingInput"
                ...
                <div class="form-floating mb-3">
                    <input
                        value="{{ old('DaysToAutopurgeIfEventOlderThan', $localConfig->DaysToAutopurgeIfEventOlderThan) }}"
                        type="number" name="DaysToAutopurgeIfEventOlderThan" class="form-control" id="floatingInput"
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('AvatarsCachePath', $localConfig->AvatarsCachePath) }}" type="text"
                        name="AvatarsCachePath" class="form-control" id="floatingInput"
                        placeholder="Directorio de cache de Avatares">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="AdvancedGUI" id="AdvancedGUI" value="1"
                        {{ old('AdvancedGUI', $localConfig->AdvancedGUI) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('NumberOfItemsPerPage', $localConfig->NumberOfItemsPerPage) }}" type="number"
                        name="NumberOfItemsPerPage" class="form-control" id="floatingInput"
                ...
                <!-- Campo BackupDBPath -->
                <div class="form-floating mb-3">
                    <input value="{{ old('BackupDBPath', $localConfig->BackupDBPath) }}" type="text"
                        name="BackupDBPath" class="form-control" id="floatingInput"
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('HoursBetweenBackupDB', $localConfig->HoursBetweenBackupDB) }}" type="number"
                        name="HoursBetweenBackupDB" class="form-control" id="floatingInput"
                ...
                <div class="form-floating mb-3">
                    <input value="{{ old('DaysToKeepBackupDB', $localConfig->DaysToKeepBackupDB) }}" type="number"
                        name="DaysToKeepBackupDB" class="form-control" id="floatingInput"
                ...
                <!-- Campo Aux1Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux1Limit', $localConfig->Aux1Limit) }}" type="number" step="0.01"
                        name="Aux1Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 1">
                ...
                <!-- Campo Aux2Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux2Limit', $localConfig->Aux2Limit) }}" type="number" step="0.01"
                        name="Aux2Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 2">
                ...
                <!-- Campo Aux3Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux3Limit', $localConfig->Aux3Limit) }}" type="number" step="0.01"
                        name="Aux3Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 3">
                ...
                <!-- Campo Aux4Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux4Limit', $localConfig->Aux4Limit) }}" type="number" step="0.01"
                        name="Aux4Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 4">
                ...
                <!-- Campo Aux5Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux5Limit', $localConfig->Aux5Limit) }}" type="number" step="0.01"
                        name="Aux5Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 5">
                ...
                <!-- Campo Aux6Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux6Limit', $localConfig->Aux6Limit) }}" type="number" step="0.01"
                        name="Aux6Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 6">
                ...
                <!-- Campo Aux7Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux7Limit', $localConfig->Aux7Limit) }}" type="number" step="0.01"
                        name="Aux7Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 7">
                ...
                <!-- Campo Aux8Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux8Limit', $localConfig->Aux8Limit) }}" type="number" step="0.01"
                        name="Aux8Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 8">
                ...
                <!-- Campo Aux9Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux9Limit', $localConfig->Aux9Limit) }}" type="number" step="0.01"
                        name="Aux9Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 9">
                ...
                <!-- Campo Aux10Limit -->
                <div class="form-floating mb-3">
                    <input value="{{ old('Aux10Limit', $localConfig->Aux10Limit) }}" type="number" step="0.01"
                        name="Aux10Limit" class="form-control" id="floatingInput"
                        placeholder="Límite saldo Recarga Auxiliar 10">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="ForceAllowExports" id="ForceAllowExports"
                        value="1"
                        {{ old('ForceAllowExports', $localConfig->ForceAllowExports) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="AutoAddIPsToBan" id="AutoAddIPsToBan"
                        value="1" {{ old('AutoAddIPsToBan', $localConfig->AutoAddIPsToBan) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="AutoAddMACsToBan" id="AutoAddMACsToBan"
                        value="1" {{ old('AutoAddMACsToBan', $localConfig->AutoAddMACsToBan) == 1 ? 'checked' : 0 }}>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="OnCloseTicketTypeIPCreation1"
                        ...
                        {{ old('OnCloseTicketTypeIPCreation1', $localConfig->OnCloseTicketTypeIPCreation1) ? 'checked' : 0 }}>
                    <label class="form-check-label" for="OnCloseTicketTypeIPCreation1">Usar IP de creación 1</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeFilter1Textarea">Lista de tipos de tickets para este filtro (separar con
                        comas o salto de línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeAllowIPs1Textarea">Lista de IPs permitidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeBanIPs1Textarea">Lista de IPs prohibidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="OnCloseTicketTypeIPCreation2"
                        ...
                        {{ old('OnCloseTicketTypeIPCreation2', $localConfig->OnCloseTicketTypeIPCreation2) ? 'checked' : 0 }}>
                    <label class="form-check-label" for="OnCloseTicketTypeIPCreation2">Usar IP de creación 2</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeFilter2Textarea">Lista de tipos de tickets para este filtro (separar con
                        comas o salto de línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeAllowIPs2Textarea">Lista de IPs permitidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeBanIPs2Textarea">Lista de IPs prohibidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="OnCloseTicketTypeIPCreation3"
                        ...
                        {{ old('OnCloseTicketTypeIPCreation3', $localConfig->OnCloseTicketTypeIPCreation3) ? 'checked' : 0 }}>
                    <label class="form-check-label" for="OnCloseTicketTypeIPCreation3">Usar IP de creación 3</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeFilter3Textarea">Lista de tipos de tickets para este filtro (separar con
                        comas o salto de línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeAllowIPs3Textarea">Lista de IPs permitidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeBanIPs3Textarea">Lista de IPs prohibidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="OnCloseTicketTypeIPCreation4"
                        ...
                        {{ old('OnCloseTicketTypeIPCreation4', $localConfig->OnCloseTicketTypeIPCreation4) ? 'checked' : 0 }}>
                    <label class="form-check-label" for="OnCloseTicketTypeIPCreation4">Usar IP de creación 4</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeFilter4Textarea">Lista de tipos de tickets para este filtro (separar con
                        comas o salto de línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeAllowIPs4Textarea">Lista de IPs permitidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeBanIPs4Textarea">Lista de IPs prohibidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" name="OnCloseTicketTypeIPCreation5"
                        ...
                        {{ old('OnCloseTicketTypeIPCreation5', $localConfig->OnCloseTicketTypeIPCreation5) ? 'checked' : 0 }}>
                    <label class="form-check-label" for="OnCloseTicketTypeIPCreation5">Usar IP de creación 5</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeFilter5Textarea">Lista de tipos de tickets para este filtro (separar con
                        comas o salto de línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeAllowIPs5Textarea">Lista de IPs permitidas (separar con comas o salto de
                        línea)</label>
                ...
                <div class="form-floating mb-3">
                    ...
                    <label for="OnCloseTicketTypeBanIPs5Textarea">Lista de IPs prohibidas (separar con comas o salto de
                        línea)</label>

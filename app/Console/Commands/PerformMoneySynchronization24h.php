...
class PerformMoneySynchronization24h extends Command
{
     ...
     * @var string
     */
    protected $signature = 'prometeo:sync-money-synchronization24h {local_id?}';
        ...
        try {
            ...
            foreach ($hcmoneystorage as $item) {
                ...
                try {
                    ...
                    DB::rollBack();
                    Log::error('Error sincronizando hcmoneystorage para local_id: ' . $local->id . ' - ' . $e->getMessage());
                }
            }
            ...
            foreach ($hiddentickets as $item) {
                ...
                try {
                    ...
                    DB::rollBack();
                    Log::error('Error sincronizando hiddentickets para local_id: ' . $local->id . ' - ' . $e->getMessage());
                }
            }
            ...
            foreach ($players as $item) {
                ...
                try {
                    ...
                    DB::rollBack();
                    Log::error('Error sincronizando players para local_id: ' . $local->id . ' - ' . $e->getMessage());
                }
            }

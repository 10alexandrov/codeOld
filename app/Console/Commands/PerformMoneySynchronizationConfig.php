...
class PerformMoneySynchronizationConfig extends Command
{
     ...
     * @var string
     */
    protected $signature = 'prometeo:sync-money-config {local_id?}';
        ...
        try {
            ...
            foreach ($config as $item) {
                ...
                try {
                    ...
                    DB::rollBack();
                    Log::error('Error updating or inserting config data for local_id ' . $local->id . ' and MoneySymbol ' . $item->MoneySymbol . ': ' . $e->getMessage());
                }
            }
